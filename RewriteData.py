...
class RewriteData:
    ...
    The purpose of this class is to combine wind and concentration data in combined file with common timeline. 
        -It further offers methods to write the data to HDF5 for viewing
        -From the HDF5 file it is then further possible to create ouptut files where the concentration and wind files are 
        shifted towards one another timewise to compensate for possible synchronization errors. This is required since 
    ...
    def __init__(self):
        ...
        enddate = "2017-03-31 23:59:59.950"
        ...
        DIR_IN = 'C:\Users\herrmann\Documents\Herrmann Lars\Licor\corrected'
        DIR_OUT = 'C:\Users\herrmann\Documents\Herrmann Lars\Licor\corrected\eddy'
        # UNCOMMENT HERE TO PROCESS
        self.rewrite_for_eddy_pro(DIR_IN, DIR_OUT)
        # ------------------------------------------------------------------------
    ...
    def rewrite_for_eddy_pro(self, input_dir, output_dir):
